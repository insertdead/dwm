...
#define BROWSEREXTRA "librewolf -P noprivacy"
...
static char *termcmd[]  = { TERMINAL, "-e", "tmux", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_q,      spawn,          SHCMD(BROWSEREXTRA) },
    { MODKEY,                       XK_e,      spawn,          SHCMD("emacsclient -nc || emacs") },
