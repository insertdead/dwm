...
static const char col_nord1[]       = "#4c566a";
static const char col_nord2[]       = "#5e81ac";
static const char col_nord3[]       = "#e5e9f0";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_nord3, col_nord0, col_nord0 },
	[SchemeSel]  = { col_nord3, col_nord1, col_nord1  },
};
